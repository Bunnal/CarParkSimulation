...
/**
 * Visual representation of the exit gate from the parking lot.
 * Displays a traffic light indicator and gate barrier.
 * 
 * @author Car Park Management System
 * @version 2.0
 */
public class ExitGate extends Group {
    
    private Circle trafficLight;
    private boolean isOpen;
    
    /**
     * Creates a new exit gate with traffic light and barrier.
     */
    public ExitGate() {
        isOpen = false;
        createGate();
    ...
    private void createGate() {
        ...
        // Gate label
        Text gateLabel = new Text("EXIT");
        gateLabel.setFont(Font.font("Arial", FontWeight.BOLD, 14));
        gateLabel.setFill(Color.DARKORANGE);
        gateLabel.setLayoutX(15);
